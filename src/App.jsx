    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        ...
        <div className="bg-green p-12">
          ...
          <p className="font-lexend mb-7">Escolha um SUV pelo seu interior espaçoso, poder e versatilidade.
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <p className="font-lexend mb-7">Passeie nos melhores carros sem os preços exorbitantes.
