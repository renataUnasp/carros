    ...
    <main>
      <section>
        ...
        <div className="bg-green">
          ...
          <p className="font-lexend">Escolha um SUV pelo seu interior espaçoso, poder e versatilidade.
        ...
        <div className="bg-dark-green">
          ...
          <p className="font-lexend">Passeie nos melhores carros sem os preços exorbitantes.
